                                ...
                                <tr>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <a href="javascript:void(0)" class="icon-btn ml-1 editBtn"
                                           ...
                                           data-url="{{ route('admin.project-categories.update', $category->id)}}"
                                        ...
                                        <a href="javascript:void(0)" class="icon-btn btn--danger ml-1 deleteBtn"
                                           ...
                                           data-url="{{ route('admin.project-categories.destroy', $category->id) }}">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel"><i
                                class="fa fa-share-square"></i> @lang('Add New Project Categories')</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">×</span></button>
                </div>
                @include('admin.language_selector')

                <form class="form-horizontal" method="post" action="{{ route('admin.project-categories.store')}}"
