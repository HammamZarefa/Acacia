                            ...
                            @forelse ($languages as $item)
                                <tr>
                                    ...
                                    <td data-label="@lang('Action')">
                                        ...
                                        <a href="javascript:void(0)" class="icon-btn ml-1 editBtn" data-original-title="@lang('Edit')" data-toggle="tooltip" data-url="{{ route('admin.language.manage.update', $item->id)}}"
                                           data-lang="{{ json_encode($item->only('name', 'text_align', 'is_default')) }}" data-icon="{{ getImage($path .'/'. $item->icon,$size)}}">
