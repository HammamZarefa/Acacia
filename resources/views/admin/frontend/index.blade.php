                                                    ...
                                                    <div class="image-upload">
                                                        <div class="thumb">
                                                            ...
                                                            <div class="avatar-edit">
                                                                <input type="file" class="profilePicUpload" name="image_input[{{ $imgKey }}]" id="profilePicUpload{{ $loop->index }}" accept=".png, .jpg, .jpeg .webp">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="image-upload">
                                                <div class="thumb">
                                                    ...
                                                    <div class="avatar-edit">
                                                        <input type="file" class="profilePicUpload" name="image_input[{{ $imgKey }}]" id="addImage{{ $loop->index }}" accept=".png, .jpg, .jpeg .webp">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="image-upload">
                                                <div class="thumb">
                                                    ...
                                                    <div class="avatar-edit">
                                                        <input type="file" class="profilePicUpload" name="image_input[{{ $imgKey }}]" id="uploadImage{{ $loop->index }}" accept=".png, .jpg, .jpeg .webp">
