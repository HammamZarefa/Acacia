                            ...
                            <div class="payment-method-header d-flex flex-wrap">
                                <div class="thumb">
                                    ...
                                    <div class="avatar-edit">
                                        <input type="file" name="image" class="profilePicUpload" id="image" accept=".png, .jpg, .jpeg .webp"/>
                                ...
                                <div class="payment-method-item child--item">
                                    <div class="payment-method-header d-flex flex-wrap">
                                        <div class="thumb">
                                            ...
                                            <div class="avatar-edit">
                                                <input type="file" name="currency[{{ $currency_idx }}][image]" id="image{{ $currency_idx }}" class="profilePicUpload" accept=".png, .jpg, .jpeg .webp"/>
                        ...
                        <div class="payment-method-item child--item newMethodCurrency d-none">
                            ...
                            <div class="payment-method-header d-flex flex-wrap">
                                <div class="thumb">
                                    ...
                                    <div class="avatar-edit">
                                        <input disabled type="file" accept=".png, .jpg, .jpeg .webp" class="profilePicUpload" id="image{{ $currency_idx }}" name="currency[{{ $currency_idx }}][image]"/>
