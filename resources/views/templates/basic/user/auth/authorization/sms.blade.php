                    ...
                    <div class="row m-0 justify-content-center">
                        <div class="col-lg-8 p-0">
                            <div class="register-form-area common-form-style bg-one create-account">
                                <h4 class="title text-center">@lang('Please Verify Your Mobile to Get Access')</h4>

                                <form class="create-account-form register-form" method="POST" action="{{route('user.verify_sms')}}">
                                    @csrf
                                    ...
                                    <div class="row justify-content-center ml-b-20">
                                        ...
                                        <div class="form-group text-center">
                                            <p>@lang('If not found, you can') <a href="{{route('user.send_verify_code')}}?type=phone" class="forget-pass text-primary"> @lang('Resend code')</a></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
